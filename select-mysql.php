 ...
 <head>
  ...
  <nav aria-label="..." style="padding-left: 5%;">
    <ul class="pagination">
      ...
      <li class="page-item active disabled"><a class="page-link" href="select-mysql.php">Libros</a></li>
      <li class="page-item">
    ...
    $result = mysqli_query( $con, "SELECT a.lib_id, a.lib_titulo, b.aut_nom FROM libros AS a INNER JOIN autor AS b ON a.aut_id = b.aut_id;" ) or die ( "Algo ha ido mal en la consulta a la base de datos");
	    ...
	    <tr>
	      <th scope="row">
		      <a href="<?php echo 'delete-mysql.php?id=' . $id ?>">
        	      	<?php echo $id; ?> .-
        	</a>
	      </th>
	      <td> <?php echo $row['lib_titulo']; ?> </td>
	      <td> <a href="<?php echo 'form-mysql.php?id=' . $id ?>"> <button type="button" class="btn tbn-inf btn-xs">Modificar</button>
	      	</a> </td>
